			...
			<td>
				<table border="0" cellspacing="0" width="100%">
					...
					<tr>
						...
						<td width="400px" valign="top" class="ms-formbody">
							<xsl:value-of select="@EmailSender" disable-output-escaping="yes"/>
						</td>
					</tr>
					<tr>
						<td width="190px" valign="top" class="ms-formlabel">
						...
						<td width="400px" valign="top" class="ms-formbody">
							<xsl:choose>
								<xsl:when test="@IsQuestion='1' or msxsl:string-compare(string(@IsQuestion),'Yes','','i')=0 or msxsl:string-compare(string(@IsQuestion),'True','','i')=0">Yes</xsl:when>
