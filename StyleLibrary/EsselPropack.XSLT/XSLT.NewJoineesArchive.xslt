...
-->
  <xsl:template name="dvt_1.rowview">
    <xsl:variable name="NewJoineeImageLink">
      <xsl:choose>
    ...
    <table class="tbl-borderbottom" width="100%" border="0" cellpadding="0" cellspacing="0">
      <tr  class="ep-archive-record">
        <td style="width: 10%; vertical-align:top; padding-top:8px; text-align:middle">
          <img class="ThumbnailStyle" src='{$NewJoineeImageLink}' alt="@EmployeeName"> </img>
        </td>
        <td style="vertical-align:top;">
          <span class="ep-newjoinees-title" style="display:block;">
          ...
          <span class="ep-newjoinees-shortdescription">
        ...
        <td class="td-leftborder" style="width: 12%;vertical-align:middle">
          ...
          <xsl:variable name="DetailPageLink" select="concat($HttpVDir,'/Lists/NewJoinees/ReadMore.aspx?ID=',$Id,'&amp;Source=',ddwrt:UrlEncode($PageUrl),'&amp;InitialTabID=Ribbon.Read')" />
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
