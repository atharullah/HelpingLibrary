  ...
  <xsl:template match="/" xmlns:x="http://www.w3.org/2001/XMLSchema">
    <span class="ep-webpart">
      <span class="ep-webpart-header">
        ...
        <span class="ep-webpart-title">Directors Message</span>
      </span>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td style="text-align:left; vertical-align:top; padding-left:5px;">
              <xsl:variable name="ArchiveViewLink" select="concat($HttpVDir,'/Lists/DirectorsMessage/ArchiveView.aspx?Source=',$PageUrl,'&amp;InitialTabID=Ribbon.Read')" />
            ...
            <xsl:choose>
              <xsl:when test="$ListRight_AddListItems">
                <td style="text-align:right; vertical-align:top; padding-right:5px">
                  <span class="ep-webpart-footer">
                    <xsl:variable name="NewPageLink" select="concat($HttpVDir,'/Lists/DirectorsMessage/NewForm.aspx?Source=',$PageUrl,'&amp;InitialTabID=Ribbon.Read')" />
                    <a href="{$NewPageLink}">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr  class="ep-webpart-record">
        <td style="vertical-align:top;">
          <img class="ThumbnailStyle" src="{$ThumbnailURL}" alt="{@DirectorName}"> </img>
        </td>
        <td style="vertical-align:middle; padding-left:5px;">
          <b>
            <xsl:value-of select="@DirectorsName" disable-output-escaping="yes" />
            <!--Check For New Item...-->
            <xsl:choose>
      ...
      <tr>
        <td style="text-align:right; padding-right:5px" colspan="2">
          ...
          <xsl:variable name="DetailPageLink" select="concat($HttpVDir,'/Lists/DirectorsMessage/ReadMore.aspx?ID=',$Id,'&amp;Source=',ddwrt:UrlEncode($PageUrl),'&amp;InitialTabID=Ribbon.Read')" />
