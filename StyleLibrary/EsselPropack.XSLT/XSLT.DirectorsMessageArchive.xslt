      ...
      <tr  class="ep-archive-record" style="width:100%">
        ...
        <td style="width:80%;" >
          <table  width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td>
                <span class="ep-directorsmessage-title" style="display:block;">
                  <b>
                ...
                <span class="ep-directorsmessage-shortdescription" style="display:block;">
        ...
        <td class="td-leftborder" style="width:10%; vertical-align:middle;">
