  ...
  <xsl:template name="dvt_1.rowview">
    <tr>
      <td class="ms-toolbar" nowrap="nowrap">
        ...
        <hr></hr>
        <p>
          <span class="ep-announcement-shortdescription" style="color:#0099CC; font-size:12px">
            <i>
          ...
          <img class="ImageStyle" style="float: left;margin: 20px;" border="0" src="{$ImageUrl}" alt="Announcement"/>
