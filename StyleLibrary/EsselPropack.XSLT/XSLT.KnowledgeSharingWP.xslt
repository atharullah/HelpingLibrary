  ...
  <xsl:template match="/" xmlns:x="http://www.w3.org/2001/XMLSchema">
    <span class="ep-webpart">
      <span class="ep-webpart-header">
        ...
        <span class="ep-webpart-title">Knowledge Sharing</span>
      </span>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td style="text-align:left; vertical-align:top; padding-left:5px">
              <xsl:variable name="ArchiveViewLink" select="concat($HttpVDir,'/Lists/KnowledgeSharing/ArchiveView.aspx?Source=',$PageUrl,'&amp;InitialTabID=Ribbon.Read')" />
            ...
            <xsl:choose>
              <xsl:when test="$ListRight_AddListItems">
                <td style="text-align:right; vertical-align:top; padding-right:5px">
                  <span class="ep-webpart-footer">
                    <xsl:variable name="NewPageLink" select="concat($HttpVDir,'/Lists/KnowledgeSharing/NewKnowledge.aspx?Source=',$PageUrl,'&amp;InitialTabID=Ribbon.Read')" />
                    <a href="{$NewPageLink}">
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      ...
      <tr>
        <td style="text-align:right; padding-right:5px">
          ...
          <xsl:variable name="DetailPageLink" select="concat($HttpVDir,'/Lists/KnowledgeSharing/ReadMore.aspx?ID=',$Id,'&amp;Source=',ddwrt:UrlEncode($PageUrl),'&amp;InitialTabID=Ribbon.Read')" />
